...
if( !isset( $args['no_blogs'] ) && $args['hide_post_creation'] == false ){ ?>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingOne">
      <button class="accordion-button collapsed fs-4" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
        Clicca qui per aggiungere un nuovo post
      </button>
    </h2>

    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div class="accordion-body js-create-post create-post-form w-100 py-4 container container-size-small">
        ...
        <?php 
            ...
            if( !empty( $args['post_insert_result'] ) ){ ?>
        ...
        <div class="row">
            <div class="col-12">
                <form class="create-posts-form w-100" method="POST" action="/progetto-sito/includes/actions/action-add-post.php" enctype="multipart/form-data">
                    
                    <?php //Questo "action" serve a specificare allo script che sto aggiungendo un post (obsoleta, deve rimanere per questioni di funzionamento) ?>
                    <input type="hidden" name="action" value="add-post">
                    <?php //Inserisco in un campo nascosto l'id del blog nel quale sto creando il post ?>
                    <input type="hidden" name="blogId" value="<?php echo $args['blogId']; ?>"/>
                    <?php //Aggiungo un opzione che specifichi che, siccome sto creando un post nella pagina blog il redirect venga fatto poi sulla pagina del blog e non sul feed ?>
                    <input type="hidden" name="redirectToBlog" value="1"/>
...
<div hidden class="js-create-post create-post-form w-100 py-4 container container-size-small">
