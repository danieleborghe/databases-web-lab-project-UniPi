<div data-post-id="<?php echo $args['codicePost']; ?>" class="js-post single-post single-post-audio card my-2">
    ...
    <div class="single-post-featured-content align-items-center d-flex justify-content-center bg-light">
        <?php if( !empty( $args['listaAllegati'] ) ){ ?>
            <audio controls>
                <source src="<?php echo $args['listaAllegati']['audio']; ?>" type="audio/mp3">
            </audio>
        <?php } ?>
    </div>
